...
The Zephyr standard library is written directly in Zephyr itself. You can selectively import individual modules as needed to keep memory footprints low.
...
Direct GC control from the script level:
...
Alternatively, use the `--profile` CLI flag to enable profiling for an entire run:
